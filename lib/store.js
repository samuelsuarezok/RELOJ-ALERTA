...
// Si existen las variables de Vercel KV / Upstash Redis, se guarda ahí (persistente
// y compartido entre la pantalla y el panel). Si no, cae a memoria del proceso,
